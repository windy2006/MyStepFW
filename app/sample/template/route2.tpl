...
<ul style="width:96%;height:auto;overflow-x:hidden;overflow-y:auto;border:1px gray dashed;padding:10px 20px;margin:20px auto;">
    <li>自定义路由：<a href="<!--root-->mySample2/"><!--root-->mySample2/</a> </li>
    <li>带路径：<a href="<!--root-->mySample2/dir1/dir2/"><!--root-->mySample2/dir1/dir2/</a> </li>
    <li>带查询字串：<a href="<!--root-->mySample2/?para1=aaa&para2=bbb"><!--root-->mySample2/?para1=aaa&amp;para2=bbb</a> </li>
    <li>带路径和查询字串：<a href="<!--root-->mySample2/dir1/dir2/?para1=aaa&para2=bbb"><!--root-->mySample2/dir1/dir2/?para1=aaa&amp;para2=bbb</a> </li>
</ul>
