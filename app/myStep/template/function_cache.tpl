        ...
        <form method="post">
            <table class="table table-sm table-striped table-hover mb-4 border-bottom">
                <tr>
                    ...
                    <td class="align-middle" width="60"><button class="btn btn-primary btn-sm mr-3" type="button" value="256"> 清除 </button></td>
                </tr>
                <tr>
                    ...
                    <td class="align-middle" width="60"><button class="btn btn-primary btn-sm mr-3" type="button" value="512"> 清除 </button></td>
                </tr>
                <tr>
                    <td class="align-middle" width="100"><b>脚本缓存：</b></td>
                    <td>各应用所用到样式表及JS脚本缓存<br /><span class="text-secondary font-sm">（当前容量：<!--script-->）</span></td>
                    <td class="align-middle" width="60"><button class="btn btn-primary btn-sm mr-3" type="button" value="1"> 清除 </button></td>
                </tr>
                <tr>
                    ...
                    <td class="align-middle" width="60"><button class="btn btn-primary btn-sm mr-3" type="button" value="2"> 清除 </button></td>
                </tr>
                <tr>
                    <td class="align-middle" width="100"><b>语言缓存：</b></td>
                    <td>供客户端脚本调用的语言包缓存<br /><span class="text-secondary font-sm">（当前容量：<!--language-->）</span></td>
                    <td class="align-middle" width="60"><button class="btn btn-primary btn-sm mr-3" type="button" value="4"> 清除 </button></td>
                </tr>
                <tr>
                    ...
                    <td class="align-middle" width="60"><button class="btn btn-primary btn-sm mr-3" type="button" value="8"> 清除 </button></td>
                </tr>
                <tr>
                    ...
                    <td class="align-middle" width="60"><button class="btn btn-primary btn-sm mr-3" type="button" value="16"> 清除 </button></td>
                </tr>
                <tr>
                    <td class="align-middle" width="100"><b>临时文件：</b></td>
                    <td>网站临时文件存放目录，可随时清除<br /><span class="text-secondary font-sm">（当前容量：<!--tmp-->）</span></td>
                    <td class="align-middle" width="60"><button class="btn btn-primary btn-sm mr-3" type="button" value="32"> 清除 </button></td>
                </tr>
                <tr>
                    ...
                    <td class="align-middle" width="60"><button class="btn btn-primary btn-sm mr-3" type="button" value="64"> 清除 </button></td>
                </tr>
                <tr>
                    ...
                    <td class="align-middle" width="60"><button class="btn btn-primary btn-sm mr-3" type="button" value="128"> 清除 </button></td>
                </tr>
            </table>
...
$(function(){
    $('button').click(function(){
        ...
        location.href = 'index.php?manager/function/cache/?id='+this.value;
    });
});
</script>