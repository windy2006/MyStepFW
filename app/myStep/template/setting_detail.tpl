<div class="card w-100 mb-3 mb-sm-2">
    ...
    <div class="card-body p-0">
        <form method="post">
            ...
            <table class="table table-sm table-striped table-hover mb-2 border-bottom" data-toggle="tooltip" data-placement="top" title="可在代码中直接通过别名调用对应方法，本方法需要通过mystep类声明实例才能自动生效，否则请通过regAlias方法注册别名（框架类均可），如改变可能会导致已有程序无法正常执行，请谨慎！">
