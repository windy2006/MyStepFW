...
<script language="JavaScript" type="text/javascript">
    ...
    function tinymceInit(obj){
        ...
        tinymce.init({
            ...
            toolbar1 : "newdocument,fullscreen,preview,|,undo,redo,restoredraft,removeformat,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,forecolor,backcolor,|,table,|,ltr,rtl,|,styleselect,formatselect,fontselect,fontsizeselect",
            toolbar2 : "print,searchreplace,hr,subscript,superscript,|,cut,copy,paste,pastetext,|,bullist,numlist,|,outdent,indent,blockquote,|,link,unlink,anchor,image,media,|,emoticons,charmap,|,change,format,code",
            toolbar3 : "",
